...
echo.
echo Terminal 1: uvicorn backend on 0.0.0.0:8001
...
start "Scrabble Vision - Backend" cmd /k "cd /d %~dp0 && uv run uvicorn server:app --host 0.0.0.0 --port 8001 --reload"
timeout /t 2 /nobreak >nul
start "Scrabble Vision - ngrok" cmd /k "ngrok http 8001"